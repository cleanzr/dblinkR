...
We will be using a dataset called `RLdata500` that formerly available in 
the RecordLinkage R package (now deprecated). For convenience, we have 
included the dataset in `dblinkR`.
...
full name and date of birth, however these attributes may be distroted. 
