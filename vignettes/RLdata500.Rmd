...
### Posterior estimates
We can use the posterior samples to make inferences about unknown quantities. 
First, we consider the number of unique entities present in the data. 
This summary statistics is stored in the diagnostics, and we use the 
samples to generate a histogram below. The red line represents the ground 
truth.
