...
[@steorts_entity_2015](https://projecteuclid.org/euclid.ba/1441790411), 
with extensions proposed in
[@marchant_d-blink_2019](https://arxiv.org/abs/1909.06039).
...
use the `dblinkR` to perform entity resolution for a small synthetic data 
set. This example is small enough to run well on a laptop (Spark cluster 
not required).
